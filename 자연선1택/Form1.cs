    ...
    public partial class Form1 : Form
    {
        ...
        public void EAT(int still)
        {
            ...
            for (int rou = 0; rou < counter; rou++)
            {
                ...
                {
                    if (space[rou].Left + still >= food[rou2].Left && space[rou].Left < food[rou2].Left + 10
                        && space[rou].Bottom + still > food[rou2].Bottom && space[rou].Bottom < food[rou2].Bottom + 10)
                    {
        ...
        public void SPACEEAT(int still, int[] size)
        {
            ...
            for (int rou = 0; rou < counter; rou++)
            {
                ...
                {
                    if (space[rou].Left + still >= space[rou2].Left && space[rou].Left < space[rou2].Left + size[rou2]
                        && space[rou].Bottom + still > space[rou2].Bottom && space[rou].Bottom < space[rou2].Bottom + size[rou2])
                    {
        ...
        private async void awa(System.Timers.Timer timer, int timerstop)
        {
        ...
        private void TickEvent(int j)
        {
            ...
            EAT(Convert.ToInt32(Fstill.Text));
            cou[j]++;
        }
        ...
        {
            this.SPACE(Convert.ToInt32(number.Text));
        }
        ...
        private async void button4_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < counter2; i++)
            {
                ...
                this.FOOD();
                score = Enumerable.Repeat<int>(0, 10000).ToArray<int>();
